      ...
      <div class="container animated fadeIn">
        ...
        <div class="login-panel panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title"><a href="admin_registration_view.php"><i class="fa fa-fw fa-chevron-circle-left"></i></a>&nbsp;Add new service</h3>
          </div>
          <div class="panel-body">
          <form name="admin_add" action="php/master_add.php" method="post">
            <div class="input-group mb1">
              <span class="input-group-addon" id="basic-addon1"><i class="fa fa-pencil fa-fw" id="usernamei"></i></span>
              <input type="text" name="service_name" class="form-control" placeholder="Service Name" aria-describedby="basic-addon1">
            </div>
